...
const EXACT: Record<string, string> = {
  ...
  comment_not_visible: "Chưa nhìn thấy bình luận cần tìm",
  comment_search_timeout: "Đã hết thời gian tìm bình luận",
  comment_search_deadline: "Đã hết giờ của phiên tương tác",
  comment_search_cancelled: "Đã dừng tìm bình luận",
  comment_read_failed: "Không đọc được danh sách bình luận",
  comment_ambiguous: "Có nhiều bình luận trùng nội dung",
  hidden_comments_ambiguous: "Chưa xác định duy nhất vùng bình luận bị ẩn",
  hidden_comments_unsupported: "Chưa nhận diện được nút mở bình luận bị ẩn",
  comment_parent_not_visible: "Chưa xác minh được nhánh bình luận cha",
  comment_verification_pending: "Đã thao tác gửi — đang xác minh nội dung",
