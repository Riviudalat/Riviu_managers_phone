...
export interface InspectorSnapshot {id:string;udid:string;package:string;version:string;locale:string;width:number;height:number;pngBase64:string;treeSha256:string;elements:InspectorElement[]}
